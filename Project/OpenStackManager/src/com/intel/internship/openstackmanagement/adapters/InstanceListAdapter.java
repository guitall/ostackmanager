...
public class InstanceListAdapter extends BaseAdapter{
	...
	public InstanceListAdapter(Context mContex, List<Instance> instance){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txV_instanceStatus.setText(ins.getStatus());
	...
	public void updateRow(Instance instance){
		for (int i = 0; i < instances.size(); i++) {
			if(instances.get(i).getId().compareTo(instance.getId())== 0){
